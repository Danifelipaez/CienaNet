...
│  │  alert_service (semáforo + tormenta) · ai_service ·             │ │
...
│  │  de agua dulce, vendaval — outlook, estimaciones sin push;      │ │
│  │  tormenta — nowcast por rayos, SÍ dispara WhatsApp, ver         │ │
│  │  docs/ALERTAS_VENDAVAL.md) ·                                   │ │
│  │  ingestion/{weather,lightning,satellite,alerts_ext,ideam_hidro} │ │
│  └──────────────────────────┬───────────────────────────────────--┘ │
└─────────────────────────────┼────────────────────────────────------┘
                              │
                    ┌─────────▼─────────┐
